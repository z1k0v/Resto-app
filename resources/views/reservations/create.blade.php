...
<body>
    ...
    <form method="post" action="{{ route('reservation.store') }}">
        ...
        <div>
            ...
            <input type="datetime-local" id="datentime" name="datentime" placeholder="Date and Time">
        </div>

        <div>
            <input type="submit" value="Save a new Reservation"/>
        </div>
    </form>
</body>
</html>
...
<div>
    ...
    <input type="datetime-local" name="datentime" placeholder="Date and Time">
</div>
